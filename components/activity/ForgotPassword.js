        ...
        return (
            <View>
                <View style={styles.viewStyle}>
                    <ScrollView>
                        <Text style={styles.letsLogin}>Let's Recover your password</Text>
                        ...
                        <View style={styles.cardviewStyle}>
                            <CardView
                                ...
                                cornerRadius={15}>
                                    ...
                                    <Text style={styles.recoveryInstText}>Please provide the email associated with your account</Text>
                                <TextInput
